    ...
    <div className="tnb">
      <ul>
        <li onClick={() => handleItemClick('hotissue')}>
          <a className={selectedItem === 'hotissue' ? 'active' : ''}>
        ...
        <li onClick={() => handleItemClick('national')}>
          <a className={selectedItem === 'national' ? 'active' : ''}>
        ...
        <li onClick={() => handleItemClick('hotphotozone')}>
          <a className={selectedItem === 'hotphotozone' ? 'active' : ''}>
        ...
        <li onClick={() => handleItemClick('campingzone')}>
          <a className={selectedItem === 'campingzone' ? 'active' : ''}>
        ...
        <li onClick={() => handleItemClick('bestview')}>
          <a className={selectedItem === 'bestview' ? 'active' : ''}>
